/* $Id: download.c,v 1.1.1.1 2001/05/17 11:50:26 dbalster Exp $ */
...
static char *option_help[] = {
	...
	N_("number of bytes to download (default: 0)"),
};
...
int main (int argc, char **argv)
{
	...
	FILE *file = stdout;
	int pccl;
	u_long size = 0, address = 0x80010000;
	...
	*/
	...
	if (size == 0) errorf(_("size must be greater than zero"));
