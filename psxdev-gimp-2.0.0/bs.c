...
query ()
{
	...
	static GParamDef save_args[] =
	{
		...
		{ PARAM_INT32,		"type",			"BS type" },
		{ PARAM_INT32,		"qscale",		"BS Q scale" },
	};
	...
	gimp_install_procedure ("file_bs_save",
		"Saves Sony Playstation .BS files",
		"BS images are used internally on the PSX",
		"Daniel Balster <dbalster@psxdev.de>",
		"Daniel Balster <dbalster@psxdev.de>",
		"2000",
		"<Save>/BS",
	...
	gimp_install_procedure ("file_bs_load",
		"Loads Sony Playstation .BS files",
		"BS images are used internally on the PSX",
		"Daniel Balster <dbalster@psxdev.de>",
		"Daniel Balster <dbalster@psxdev.de>",
		"2000",
	...
	gimp_install_procedure ("bs_config",
		"configure libbs options",
		"This is an awful solution...",
		"Daniel Balster <dbalster@psxdev.de>",
		"Daniel Balster <dbalster@psxdev.de>",
		"2000",
		"<Toolbox>/PSX/Config BS",
		"",
		PROC_EXTENSION,
		nconfig_args, 0, config_args, NULL);

	gimp_register_magic_load_handler ("file_bs_load", "bs", "",
		"2&,short,0x3800");

	gimp_register_save_handler ("file_bs_save", "bs", "");
}
     ...
     GParam **return_vals)
{
	...
	if (gimp_get_data_size("bs_compression")==0)
	{
		gint value;
	...
	*return_vals = values;
	...
	if (strcmp (name, "bs_config") == 0)
	{
		config_dialog ();
	}

	if (strcmp (name, "file_bs_load") == 0)
	{
		switch (run_mode)
		{
	...
	//		if (nparams != 3) status = STATUS_CALLING_ERROR;
			break;
